"""
===============================================================================
📊 Shoot_Catcher — Benchmark Runner: External Test Audio (Option A)
===============================================================================
Evaluates all 5 trained models on newly provided / downloaded audio:
  - My_Test_Audio/Actual_Gunshots/ (Label: 1)
  - My_Test_Audio/Like_Gunshots/   (Label: 0 - Hard Imposters: Fireworks, Claps, Knocks)
  - My_Test_Audio/Not_Gunshots/    (Label: 0 - Ambient: Rain, Engines, Dogs, Sirens)

Applies a sliding 750ms window (with 75% overlap) across each file.
Outputs overall metrics and detailed breakdown by sound category.
===============================================================================
"""
...
def evaluate_file_with_sliding_window(model, audio_data, sr):
    ...
    for i in range(num_windows):
        ...
        window = y[-WINDOW_SAMPLES:] if end > len(y) else y[start:end]
...
def main():
    ...
    print("=" * 85)
    print("🎯 SHOOT_CATCHER — 5-MODEL BENCHMARK: EXTERNAL RECORDINGS")
    print("=" * 85)
    ...
    for idx, (fpath, true_label, cat_name) in enumerate(test_suite, 1):
        ...
        print(f"[{idx:>2}/{total_files}] Scanning: {fpath.name[:35]:<35} ({cat_name})")
    ...
    print("=" * 100)
    print("📊 OVERALL PERFORMANCE SCORECARD (ALL EXTERNAL TEST FILES)")
    print("=" * 100)
